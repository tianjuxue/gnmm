...
def plot_S_wave():
    ...
    plt.plot(dummy_x, wave_travelled_vel[0], linestyle='-', marker='o', markersize=10, linewidth=2, color='red', label='fully connected')
    plt.plot(dummy_x, wave_travelled_vel[1], linestyle='-', marker='s', markersize=10, linewidth=2, color='blue', label='partially connected')    
